...
$('#row'+button_id+'').remove();
   ...
   <div class="container" style="margin-top: 130px;">
    <h2 align="center"><font color="#00008B"><i>EDUCATION DETAILS</i></font></h2><br />
    <div class="form-group">
<form name="add_name" id="add_name" method="post">
<div class="table-responsive">
    <center>
<table>
    <td><center><div class="col">COURSE/DEGREE<font color="red">*</font></div><br><input type="text" class="tab" name="course"  class="form-control name_list" /><br><div class="col">COLLEGE<font color="red">*</font></div><br><input class="tab" type="text" name="college"  class="form-control name_list" /><br><div class="col">GRADE/SCORE<font color="red">*</font></div><br><input class="tab" type="text" name="grade"  class="form-control name_list" /><br><div class="col">YEAR<font color="red">*</font></div><br><input class="tab" type="text" name="year"  class="form-control name_list" /><br><input class="ta" type="submit" name="submit"  value="SAVE" /></td></center></tr>
</table>
</center>
</div>
...
$insertquery="INSERT INTO education(course,college,grade,year)
 VALUES ('$course','$college','$grade','$year')";
