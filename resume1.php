...
else
{
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		echo "<tr ><td colspan='2'><fieldset class='fi'><div class='tl'>objective</div> <br/><div class='t'>".$row['objective']."</div></fieldset><div class='hr'><hr/></div><fieldset class='fi'> <div class='tl'>Education</div><br/><div class='t'>".$row['college']."<br/>".$row['course']."<br/>Passing Year: ".$row['year']."<br/>Score: ".$row['grade']."</div></fieldset><div class='hr'><hr/></div></td></tr>";

		echo "<tr ><td colspan='2'><fieldset class='fi'> <div class='tl'>Skills</div> <br/><div class='t'>".$row['skill']."</div></fieldset><div class='hr'><hr/></div> <fieldset class='fi'><div class='tl'>Project</div><br/><div class='t'>".$row['title']."<br/>".$row['description']."</div></div></fieldset><div class='hr'><hr/></td></tr>";
echo "<tr ><td colspan='2'><fieldset class='fi'> <div class='tl' >Languages</div> <br/><div class='t'>".$row['language']."</div></fieldset><div class='hr'><hr/></div><fieldset class='fi'> <div class='tl'>Achievements And Awards</div><br/><div class='t'>".$row['achiev']."</div></fieldset><div class='hr'><hr/></div></td></tr>";
echo "<tr><td colspan='2'><fieldset class='fi'> <div class='tl'><div class='tf'></div>Hobbies</div><br/><div class='t'>".$row['hobbies']."</div></fieldset><div class='hr'><hr/></div></td></tr><br><br>";
