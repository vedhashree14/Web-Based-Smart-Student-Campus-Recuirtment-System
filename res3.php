  ...
  <script type="text/javascript">
    ...
    if ( name.value == "") {
      ...
      return false;
        ...
        {
          window.alert("Congratulations!!, Know you can download your resume.")
        }
    return true;
  }
  </script>
...
<header>
   <a href="view.html"><button style=" height:30px;border-radius: 30px;width:100px;background-color: #00008B; color: white;margin-left: 1200px;">LOGOUT</button></font></span></a>
</header>
<body>
  <center>
    <fieldset style="margin-top: 50px;width:60%;font-size: 30px;background-color:#00008B;color: white;border-radius: 100px;">ENTER YOUR USERNAME TO GET YOUR RESUME</fieldset>
<form action="resume1.php" method="post" name="RegForm"  onsubmit="return validation()" >  
