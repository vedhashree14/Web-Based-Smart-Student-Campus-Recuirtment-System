...
else
{
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		echo "<tr ><td colspan='2' class='tf'><center><div class='tt'><hr/></div>".$row['name'].$row['lname']."<br/>".$row['address']."Contact: ".$row['phone']."<br/>Email: ".$row['email']."</td></tr>";
		

		echo "<tr ><td colspan='2'><div class='tl'><hr/>objective</div> <br/><div class='t'>".$row['objective']."</div><div class='hr'><hr/></div><br/> <div class='tl'><hr/>Education</div><br/><div class='t'>".$row['college']."<br/>".$row['course']."<br/>Passing Year: ".$row['year']."<br/>Score: ".$row['grade']."</div><div class='hr'><hr/></div></td></tr>";

		echo "<tr ><td colspan='2'> <div class='tl'><hr/>Skills</div> <br/><div class='t'>".$row['skill']."</div><div class='hr'><hr/></div><br/> <div class='tl'><hr/>Project</div><br/><div class='t'>".$row['title']."<br/>".$row['description']."</div></div><div class='hr'><hr/></td></tr>";
echo "<tr ><td colspan='2'> <div class='tl' ><hr/>Languages</div> <br/><div class='t'>".$row['language']."</div><div class='hr'><hr/></div><br/> <div class='tl'><hr/>Achievements And Awards</div><br/><div class='t'>".$row['achiev']."</div><div class='hr'><hr/></div></td></tr>";
echo "<tr><td colspan='2'> <div class='tl'><div class='tf'><hr/></div>Hobbies</div><br/><div class='t'>".$row['hobbies']."</div><div class='hr'><hr/></div></td></tr>";
