    ...
    <nav class="navbar navbar-default navbar-fixed-top" >
        <div class="container">
            <div class="navbar-header">
                ...
                <center><h5 style="font-size:20px;"><font color="#00008B"><i>CAMPUS RECRUTMENT SYSTEM</i></font></h5></center>
            </div>
...
$('#row'+button_id+'').remove();
   ...
   <div class="container" style="margin-top: 130px;">
    <h2 align="center"><font color="#00008B"><i>ACHIEVEMENTS AND AWARDS</i></font></h2><br />
    <div class="form-group">
<form name="add_name" id="add_name" method="post">
<div class="table-responsive">
    <center>
<table id="dynamic_field" >
<td><center><div class="col">Achivements and Awards<font color="red">*</font></div><br><input type="text" class="tab" name="achiev"  class="form-control name_list" /><br><input class="ta" type="submit" name="submit"  value="SAVE" /></td></center></tr>
</table>
</center>
</div>
...
$insertquery="INSERT INTO achiev(achiev)
 VALUES ('$achiev')";
