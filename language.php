...
$('#row'+button_id+'').remove();
   ...
   <div class="container" style="margin-top: 130px;">
    <h2 align="center"><font color="#00008B"><i>LANGUAGES</i></font></h2><br />
    <div class="form-group">
<form name="add_name" id="add_name" method="post">
<div class="table-responsive">
    <center>
<table id="dynamic_field" >
<td><center><div class="col">Languages<font color="red">*</font></div><br><input type="text" class="tab" name="language"  class="form-control name_list" /><br><input class="ta" type="submit" name="submit"  value="SAVE" /></td></center></tr>
</table>
</center>
</div>
...
$insertquery="INSERT INTO language(language)
 VALUES ('$language')";
