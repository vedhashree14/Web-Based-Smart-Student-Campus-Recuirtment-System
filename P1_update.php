...
if(isset($_POST['done'])){
  $id=$_GET['id'];
  $placed=$_POST['placed'];
  $q="UPDATE `resume1` set id=$id, placed='$placed' where id=$id ";
...
<body>
    ...
    <form method="post">
     <br><br><div class="container" style="margin-top: 25%;">
          ...
          <h5 style="color="#00008B>STATUS</h5>
          <input type="text" style="border-color: #00008B;" name='placed' class='form-control'>
