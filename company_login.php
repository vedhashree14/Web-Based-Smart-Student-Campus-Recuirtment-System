...
<body>
   ...
   <a href="dashboard.html"><button style=" height:30px;border-radius: 30px;color: white; width:100px;background-color: #00008B;margin-left: 1400px;">LOGOUT</button></font></span></a>
<center>
