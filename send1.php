...
<body>
    <center>
   <legend style="margin-top:10% ;color:#00008B"><i>Job Description for placed students</i></legend>
...
$cgpa=$_POST['cgpa'];
 ...
 $sql="INSERT INTO student3(company,des,cgpa,file,type,size) VALUES('$company','$des','$cgpa','$file','$file_type','$file_size')";
