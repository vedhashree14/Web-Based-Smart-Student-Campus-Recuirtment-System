    ...
    <nav class="navbar navbar-default navbar-fixed-top" >
        <div class="container">
            <div class="navbar-header">
                ...
                <center><h5 style="font-size:20px;"><font color="#0000B8"><i>CAMPUS RECRUTMENT SYSTEM</i></font></h5></center>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                      ...
                      <li class="dropdown" id = "old">
                        <a href="form.php"><button style=" height:30px;border-radius: 30px;width:100px;background-color: #0000B8; color: white;">LOGOUT</button></font></span>
...
$('#row'+button_id+'').remove();
   ...
   <div class="container" style="margin-top: 130px;">
    <h2 align="center"><font color="#00008B"><i> HOBBIES </i></font></h2><br />
    <div class="form-group">
<form name="add_name" id="add_name" method="post">
<div class="table-responsive">
    <center>
<table id="dynamic_field" >
<td><center><div class="col">Hobbies<font color="red">*</font><br><input type="text" class="tab" name="hobbies"  class="form-control name_list" /><br><input class="ta" type="submit" name="submit"  value="SAVE" /></td></center></tr>
</table>
</center>
</div>
...
$insertquery="INSERT INTO hobbies(hobbies)
 VALUES ('$hobbies')";
