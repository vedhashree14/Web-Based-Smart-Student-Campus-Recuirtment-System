...
<br>
<button class="btn-success btn" onclick="window.location.href='studentd.php';" style="background-color: #00008B;" ><font>SHORTLIST</font></button><br><br>
<div class="container">
<div class="col-lg-12">
<br>
...
<tr class="bg-primary text-white text-center" >
    ...
    <td style="background-color: #2916F5; color:white; padding: 10px;">  Id</td>
...
<td> <?php echo $row['email']; ?> </td>
       ...
       <center> 
<td> <button class="btn-primary btn" style="background-color: #00008B;color:white;"><a href="update.php?id=<?php echo $row['pid']; ?>" class="text-white"><font color="white">Update</a></button>  </td></center>
        </tr>
        <?php
 }
 ?>
